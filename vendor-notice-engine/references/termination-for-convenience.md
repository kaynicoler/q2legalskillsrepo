...
**Combined certification paragraph** (certification request + delivery address + deadline in one paragraph):
...
- **Certification paragraph**: write as a single combined paragraph — certification request, delivery address, and deadline together.
